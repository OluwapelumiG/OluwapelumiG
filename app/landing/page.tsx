      ...
      <div className="bg-white">
          ...
          <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">OluwapelumiG</span>
                OluwapelumiG
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-4xl py-32 sm:py-48 lg:py-56">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">Hi, I am</p>
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">AINA <br /> OLUWAPELUMI GIDEON</h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">A Web and Mobile Developer</p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a href="#" className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Resume <span aria-hidden="true">↓</span></a>
                <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Github <span aria-hidden="true">→</span></a>
              </div>
            </div>
          </div>
